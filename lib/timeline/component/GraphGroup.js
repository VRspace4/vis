...
GraphGroup.prototype.getLegend = function (iconWidth, iconHeight, framework, x, y) {
  ...
  switch (this.options.style){
    ...
    case "bar":
      ...
      break;
    case "box":
	  Boxes.drawIcon(this, x, y, iconWidth, iconHeight, framework);
	  break;
  }
...
GraphGroup.prototype.getYRange = function (groupData) {
  if (this.options.style === 'box') {
    var yMin = groupData[0].startVal;
    var yMax = groupData[0].endVal;
    for (var j = 0; j < groupData.length; j++) {
      yMin = yMin > groupData[j].startVal ? groupData[j].startVal : yMin;
      yMax = yMax < groupData[j].endVal ? groupData[j].endVal : yMax;
    }
  }
  else {
